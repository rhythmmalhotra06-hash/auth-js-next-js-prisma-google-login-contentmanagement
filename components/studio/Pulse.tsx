...
export function Pulse({ pulse }: { pulse: PulseData }) {
  ...
  return (
    <KpiGrid>
      ...
      <Link href="/studio/launches?ticketStatus=In+Progress" className="st-kpilink">
        <Kpi label="Being made now" value={pulse.inProduction} sub="in production" i={1} />
      </Link>
      <Link href="/studio/sign-off" className="st-kpilink">
        <Kpi label="Awaiting sign-off" value={pulse.awaiting} sub="in review across teams" tone="attention" i={2} />
      </Link>
