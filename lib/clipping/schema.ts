  ...
  properties: {
      ...
      properties: {
        ...
        chapterMarkers: {
          ...
          items: {
            ...
            properties: { timestamp: str('e.g. 00:00'), label: str('Click-worthy chapter title.') },
          },
        },
      },
    },
    reelsClips: {
      ...
      items: {
        ...
        properties: {
          timestampStart: str('Clip start, e.g. 12:30.'),
          timestampEnd: str('Clip end, e.g. 13:45.'),
      ...
      properties: {
        timestamps: {
          ...
          items: {
            ...
            additionalProperties: false,
            required: ['timestamp', 'label'],
            properties: { timestamp: str('e.g. 05:12'), label: str('What happens at this timestamp.') },
          },
        },
