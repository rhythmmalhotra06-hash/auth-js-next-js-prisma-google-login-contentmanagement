...
export function mapAssetType(r: AirtableRecord) {
  return {
    ...
    hours: numVal(r.fields[ASSET_TYPES.fields.hours]),
    importance: numVal(r.fields[ASSET_TYPES.fields.importance]),
    complexity: numVal(r.fields[ASSET_TYPES.fields.complexity]),
