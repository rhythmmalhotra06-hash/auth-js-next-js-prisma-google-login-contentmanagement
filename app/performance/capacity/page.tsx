    ...
    <>
      ...
      <div className="stack" style={{ marginBottom: 18 }}>
        <InsightCard
          tone="good"
          icon="chart"
          title="Published numbers live on the Performance page"
          detail="Reach and engagement per post, by account, pulled nightly from Hootsuite. This page stays focused on capacity, throughput and risk."
        />
      </div>
...
export default async function CapacityPage() {
  ...
  const { title, sub, body, kpis } = mgr
    ? { title: 'Capacity & risk', sub: 'Throughput, capacity and risk across the studio.', body: <ManagerInsights />, kpis: 5 }
    : editor
      ? { title: 'Your workload', sub: 'What’s on you, what’s slipping, and how much you’ve shipped.', body: <EditorInsights />, kpis: 4 }
      : { title: 'Production throughput', sub: 'What the studio is producing. Published numbers live on Performance.', body: <PerformanceInsights />, kpis: 2 };
